...
# Install the latest version of gbifbf package from automation repository
echo "Installing gbifbf package from automation repository..."
Rscript -e 'install.packages("./automation/gbifbf", repos = NULL, type = "source")'
