#' Process JSON from GitHub issues
#'
#' This script processes JSON tags from GitHub issue comments
#' @export
process_json <- function(original_string, issue) {
  
  # Original script logic for command line args is now a function parameter
